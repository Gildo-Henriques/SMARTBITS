...
>
  ...
  >
    ...
    >
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          <p class="text-base font-semibold leading-7 text-blue-500">
          ...
          <p class="mt-6 text-xl leading-8 text-gray-700">
            A SMARTBITS valoriza a privacidade de seus alunos e está
            comprometida com a proteção dos seus dados pessoais. Este documento
            explica como coletamos, usamos, armazenamos e protegemos suas
            informações em nossa plataforma digital.
          </p>
        </div>
      </div>
    </div>
    ...
    >
      <img
        class=" max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 
        
        
        ring-gray-400/10 w-full sm:w-[57rem]"
        src="secretaria.jpg"
        alt=""
      />
    </div>
    ...
    >
      <div class="lg:pr-4">
        <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
          <h2
            class="text-xl font-semibold tracking-wide text-gray-800 lg:text-2xl"
          >
            1. Coleta de Dados:
          </h2>
          <p>
            Ao criar uma conta no site da SMARTBITS, alguns dados pessoais são
            coletados para garantir o funcionamento dos nossos serviços,
            incluindo, mas não se limitando a:
          </p>
          <ul class="list-disc lg:ml-10 ml-0">
            <li>Nome completo</li>
            <li>Data de nascimento</li>
            <li>Número do BI</li>
            <li>Endereço de e-mail</li>
            <li>Curso e informações acadêmicas</li>
          </ul>
